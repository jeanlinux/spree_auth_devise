module Spree
  class User < ActiveRecord::Base
    ...
    has_many :orders
    has_many :arts, :foreign_key => 'artist_id', :class_name => 'Spree::Product'
    belongs_to :country, :foreign_key => 'country_id', :class_name => 'Spree::Country'
    belongs_to :ship_address, :foreign_key => 'ship_address_id', :class_name => 'Spree::Address'
    belongs_to :bill_address, :foreign_key => 'bill_address_id', :class_name => 'Spree::Address'

    before_validation do
      request_telephone = request_telephone.to_s.gsub('-','').to_i
    end
